// Endpoints
const FURY_ENDPOINT_NMTOOL = "http://localhost:1317";
...
const BEP3_ASSETS = {
  "bnb": {
    ...
    furyDeputyHotWallet: "fury1agcvt07tcw0tglu0hmwdecsnuxp2yd4590q7dn",
  ...
  "btcb": {
    ...
    furyDeputyHotWallet: "fury1kla4wl0ccv7u85cemvs3y987hqk0afcvjjptza",
  ...
  "xrpb": {
    ...
    furyDeputyHotWallet: "fury14q5sawxdxtpap5x5sgzj7v4sp3ucncjldztrjc",
    binanceChainDeputyHotWallet: "bnb1ryrenacljwghhc5zlnxs3pd86amta3jcaagyt0",
    conversionFactor: 10 ** 8
  },
  "busd": {
    furyDenom: "busd",
    binanceChainDenom: "BUSD-BD1",// Endpoints
const FURY_ENDPOINT_NMTOOL = "http://localhost:1317";
const BINANCE_CHAIN_ENDPOINT_NMTOOL = "http://localhost:8080";
...
const BEP3_ASSETS = {
  ...
  "busd": {
    ...
    furyDeputyHotWallet: "fury1j9je7f6s0v6k7dmgv6u5k5ru202f5ffs5qqm2a",
